...
public interface ApplicantStateRepository extends JpaRepository<ApplicantState,Long> {
    ...
    List<ApplicantState> getCountOfRecruitingApplicant(String memberNo);
